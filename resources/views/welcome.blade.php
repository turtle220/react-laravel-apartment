                            ...
                            >
                                ...
                                >
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        >
                                            <a
                                                href="https://singlehotel.travelerwp.com/room-list/"
                                                >Our Cusomters</a
                                            >
                                        </li>
                                    </ul>
                                ...
                                >
                                    <a
                                        href="https://singlehotel.travelerwp.com/services/"
                                        >Our Customers</a
                                    >
                                </li>
                                <li
    ...
    <footer class="footer" style="width:102%; margin-left:auto; maring-right:auto">
            ...
            <div style="width:100%; display:flex;">
                ...
                {{-- <div style="width:20%;">
                    ...
                    <div class="st-gr-input" >
                        <input type="email" name="EMAIL" placeholder="Enter your email" style=" margin-top:50px;width:100%;">
        ...
        <div style="background-color: #414142;display:flex;color: #fff;line-height: 30px;padding: 20px 0;width:100%; margin-left:auto; margin-right:auto">
            ...
            <div style="display: flex;height: 50px;padding-left: 100px;width: 110%;">
                ...
                <a href="#" target="_self" style="font-size: 18px; color:white" class="nav-link">Locations</a>
                <a href="#" target="_self" style="font-size: 18px; color:white" class="nav-link">Our Customers</a>
