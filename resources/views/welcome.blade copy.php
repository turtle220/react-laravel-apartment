...
<html lang="{{ app()->getLocale() }}">
            ...
            <div class="control-left">
                <div class="content-menu hide_scroll">
                    <div class="option-item">
                        <div class="logo">
                            <a href="https://singlehotel.travelerwp.com/">
                    ...
                    <div class="menu-left">
                        <div class="menu-hotel-menu-container">
                            <ul id="menu-hotel-menu" class="nav et_disable_top_tier">
                                <li
                                    id="menu-item-8507"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-8460 current_page_item menu-item-8507"
                                >
                                    <a
                                        href="https://singlehotel.travelerwp.com/"
                                        aria-current="page"
                                        >Our Collection</a
                                    >
                                </li>
                                <li
                                    id="menu-item-7724"
                                    class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-7724"
                                >
                                    <a href="#">Locations</a>
                                    <ul class="sub-menu">
                                        <li
                                            id="menu-item-8454"
                                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8454"
                                        >
                                            <a href="https://singlehotel.travelerwp.com/room-list/">Our Cusomters</a>
                                        </li>
                                    </ul>
                                </li>
                                <li
                                ...
                                >
                                    <a href="https://singlehotel.travelerwp.com/services/">Our Customers</a>
                                </li>
                                <li
                                    id="menu-item-8504"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8504"
                                >
                                    <a href="https://singlehotel.travelerwp.com/gallery/">About Us</a>
                                </li>
                                    </ul>
                                </li>
                            </ul>
                ...
                <div class="option-item">
                    <div class="option-mid">
                        <div class="location-phone">
                            <span class="icon">
                                {{-- <img src="{{ asset('images/Logo/Mega-1.jpg') }}" alt="logo"/> --}}
                            </span>
                            <a href="" title="">
        ...
        <div class="container">
            ...
            >
                ...
                <div class="container">
                    <div class="row">
                        <div
                            class="wpb_column column_container col-md-12 vc_custom_1551691656912"
                        >
                            <div class="vc_column-inner wpb_wrapper">
                                {{-- <button class="icon-images-scroll">
                                    <img src="asset{{'images/slide-6'}}"alt=""/>
                                </button> --}}
                                <div
                                ...
                                >
                                    ...
                                    <div class="vinhome-slider text-normal">
                                        ...
                                        >
                                            <div
                                                class="outer"
                                                style="
                                                    background-image: url({{asset('images/slide-6.jpg')}});
                                                "
                                            ></div>
                                            <div class="inner">
                                                <div
                                            ...
                                            <div class="search-form-text">
                                                <div class="container">
                                                    <h2 class="st-heading vinhome-text">
                                                        Discover Our Melbourne Collection                                                    </h2>
                                                    <div class="sub-heading vinhome-text">
                                        ...
                                        >
                                            ...
                                            <div class="search-form-text">
                                                <div class="container">
                                                    <h2 class="st-heading vinhome-text">
                                                        Discover Our Melbourne Collection
                                                    </h2>
                                                    <div class="sub-heading vinhome-text">
                                                        Welcome to Melbourne
                                                    </div>
                                        ...
                                        >
                                            <div
                                                class="outer"
                                                style="
                                                    background-image: url({{asset('images/slide-2.jpg')}});
                                                "
                                            ></div>
                                            <div class="inner">
                                                <div
                                            ...
                                            <div class="search-form-text">
                                                <div class="container">
                                                    <h2 class="st-heading vinhome-text">
                                                        Discover Our Melbourne Collection                                                    </h2>
                                                    <div
                                                        class="sub-heading vinhome-text"
                                                    >
                                                        Which you can
                                                        experience
                                                    </div>
                                    ...
                                    <div class="vinhome-slider-controls">
                                    </div>
    ...
    <div class="row display-flex-row" style="width:1170px; margin-left:20%;" data-sf-element="Row">
            ...
            <a class="call-out-box" href="#">
                <div class="panel-content">
                    <div class="call-out-svg">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 333 410" style="enable-background:new 0 0 333 410;" xml:space="preserve">
                            <path class="st0" d="M166.9,14.7c-84.3,0-153,68.6-153,153c0,9.6,0.9,19.3,2.7,28.7c0.1,0.6,0.4,2.2,1,5.1
                            ...
                            c53.5,0,97.1,43.6,97.1,97.1C264.1,222.9,220.5,266.5,166.9,266.5z"></path>
                            </svg>    
                    </div>
                        <h2 class="">DISCOVER OUR MELBOURNE COLLECTION</h2>
                        <h3 class="">Search 170+ locations in Australasia</h3>
                </div>            
            </a>
        </div>
            ...
            <a class="call-out-box" href="#" target="_blank">
                <div class="panel-content">
                    <div class="call-out-svg">
                        ...
                        <path id="Path_966" data-name="Path 966" class="cls-1" d="M90.968,51.236a5.987,5.987,0,0,0-2.024.4V37.071A5.962,5.962,0,0,0,82.874,31H56.567a5.65,5.65,0,0,0-4.047,1.619A5.65,5.65,0,0,0,48.472,31H22.165a5.962,5.962,0,0,0-6.071,6.071v14.57A5.937,5.937,0,0,0,8,57.307V69.449a1.912,1.912,0,0,0,2.024,2.024h2.024v6.071a1.912,1.912,0,0,0,2.024,2.024h76.9a1.912,1.912,0,0,0,2.024-2.024V71.472h2.024a1.912,1.912,0,0,0,2.024-2.024V57.307A5.962,5.962,0,0,0,90.968,51.236Zm-34.4-16.189H82.874A1.912,1.912,0,0,1,84.9,37.071v22.26H54.543V37.071A1.912,1.912,0,0,1,56.567,35.047ZM20.142,37.071a1.912,1.912,0,0,1,2.024-2.024H48.472A1.912,1.912,0,0,1,50.5,37.071v22.26H20.142V37.071ZM12.047,57.307a1.912,1.912,0,0,1,2.024-2.024,1.912,1.912,0,0,1,2.024,2.024V67.425H12.047Zm76.9,18.213H16.094V71.472h2.024a1.912,1.912,0,0,0,2.024-2.024V63.378H84.9v6.071a1.912,1.912,0,0,0,2.024,2.024h2.024Zm4.047-8.094H88.945V57.307a2.024,2.024,0,0,1,4.047,0Z" transform="translate(8.189 31.732)"></path>
                        <path id="Path_967" data-name="Path 967" class="cls-1" d="M18.213,46.236a2.3,2.3,0,0,0,1.619-.607,1.574,1.574,0,0,0,.4-1.619L18.213,27.821A2.152,2.152,0,0,0,16.189,26H4.047a2.152,2.152,0,0,0-2.024,1.821L0,44.01a3.812,3.812,0,0,0,.4,1.619,2.3,2.3,0,0,0,1.619.607H8.094V84.685h4.047V46.236ZM14.368,30.047l.607,4.047H5.261l.607-4.047ZM4.857,38.142H15.38l.607,4.047H4.25Z" transform="translate(0 26.614)"></path>
                        <path id="Path_968" data-name="Path 968" class="cls-1" d="M37.165,28.331A14.078,14.078,0,0,0,51.331,14.165a14.165,14.165,0,0,0-28.331,0A14.078,14.078,0,0,0,37.165,28.331Zm0-24.283A10.02,10.02,0,0,1,47.283,14.165a10.118,10.118,0,1,1-20.236,0A10.02,10.02,0,0,1,37.165,4.047Z" transform="translate(23.543)"></path>
                        <path id="Path_969" data-name="Path 969" class="cls-1" d="M31.024,12.094h6.071a1.912,1.912,0,0,0,2.024-2.024,1.912,1.912,0,0,0-2.024-2.024H33.047V6.024a2.024,2.024,0,1,0-4.047,0v4.047A1.912,1.912,0,0,0,31.024,12.094Z" transform="translate(29.685 4.094)"></path>
                        <path id="Path_970" data-name="Path 970" class="cls-1" d="M43.024,32.236H67.307a1.912,1.912,0,0,0,2.024-2.024V14.024A1.912,1.912,0,0,0,67.307,12H43.024A1.912,1.912,0,0,0,41,14.024V30.213A1.912,1.912,0,0,0,43.024,32.236Zm2.024-16.189H65.283V28.189H45.047Z" transform="translate(41.968 12.283)"></path>
                        <path id="Path_971" data-name="Path 971" class="cls-1" d="M7.024,32.236H31.307a1.912,1.912,0,0,0,2.024-2.024V14.024A1.912,1.912,0,0,0,31.307,12H7.024A1.912,1.912,0,0,0,5,14.024V30.213A1.912,1.912,0,0,0,7.024,32.236ZM9.047,16.047H29.283V28.189H9.047Z" transform="translate(5.118 12.283)"></path>
                        <path id="Path_972" data-name="Path 972" class="cls-1" d="M26.024,19A1.912,1.912,0,0,0,24,21.024V33.165a1.912,1.912,0,0,0,2.024,2.024H46.26a1.912,1.912,0,0,0,2.024-2.024V21.024A1.912,1.912,0,0,0,46.26,19ZM44.236,31.142H28.047V23.047H44.236Z" transform="translate(24.567 19.449)"></path>
                        <path id="Path_973" data-name="Path 973" class="cls-1" d="M68.213,27.821A2.152,2.152,0,0,0,66.189,26H54.047a2.152,2.152,0,0,0-2.024,1.821L50,44.01a3.812,3.812,0,0,0,.4,1.619,2.186,2.186,0,0,0,1.417.607h6.071V84.685h4.047V46.236H68.01a2.3,2.3,0,0,0,1.619-.607,1.574,1.574,0,0,0,.4-1.619Zm-3.845,2.226.607,4.047H55.464l.607-4.047ZM54.25,42.189l.607-4.047H65.38l.607,4.047Z" transform="translate(51.181 26.614)"></path>
                        </svg>    
                    </div>
                    <h2 class="">Long Stay Accommodation</h2>
                
                    <h3 class="">Find spacious serviced apartments</h3>
                </div>            
            </a>
        </div>
        <div id="Header_C068_Col02" class="sf_colsIn col-md-4" data-sf-element="Column 3" data-placeholder-label="Column 3">
            <a class="call-out-box" href="#">
                <div class="panel-content">
                    <div class="call-out-svg">
                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                            width="4538.000000pt" style="width:80px;height:50px" height="4167.000000pt" viewBox="0 0 4538.000000 4167.000000"
                            preserveAspectRatio="xMidYMid meet">
                            <metadata>
                            Created by potrace 1.16, written by Peter Selinger 2001-2019
                            </metadata>
    ...
    <footer class="footer" style="width:102%;">
        <div class="footer-top" style="display:flex; width:100%;">
            <div style="width:76%; display:flex; margin-right:auto;">
                <div style="margin-left:400px; width:20%;">
                    <div class="sfContentBlock detial-expand">
                        <h3 style="padding-bottom:30px;">Why Mega Style Apartments</h3>
                    </div>
                ...
                <div style="width:10%; padding-left:30px;">
                    <div class="sfContentBlock detial-expand">
                        <h3 style="padding-bottom:55px">Contact Us</h3>
                    </div>
                    <p style="color: #6A6C64;text-decoration: none;font-size: 13px;line-height: 30px;">
                        ABN: 83 615 503 743
                        Address: 500 Dunns Creek Rd, Red Hill VIC 3937
                        P: 03 8488 9995
                ...
                <div style="width:20%; padding-left:100px;">
                    <div class="sfContentBlock detial-expand">
                        ...
                        <h3 style="padding-bottom:30px">Subscribe Our Newsletter</h3>
                    </div>
                    <p style="color: #6A6C64;text-decoration: none;font-size: 13px;line-height: 30px;">Send us your email to get our newsletter</p>
                    <div class="st-gr-input">
                        <input type="email" name="EMAIL" placeholder="Enter your email" style="margin:0; padding-left:0px;width:100%;">
        ...
        <div class="footer-bottom" style="width:100%;">
            <div class="container">
                <div class="row">
                    ...
                    <div  class="sf_colsIn col-md-6" data-sf-element="Footer Bottom Nav" data-placeholder-label="Footer Bottom Nav">
                        <div class="nav-wrap accordion-body">
                            <nav class="" role="navigation">
                                <ul class="sfContentBlock">
                                    <li class="nav-item "><a href="#" target="_self" class="nav-link">Our Collection</a></li>
                                    <li class="nav-item "><a href="#" target="_self" class="nav-link">Locations</a></li>
                                    <li class="nav-item "><a href="#" target="_self" class="nav-link">Our Customers</a></li>
                                    <li class="nav-item "><a href="#" target="_self" class="nav-link">About Us</a></li>
                                </ul>
                    ...
                    <div class="col-md-2 col-md-pull-8">
                        <img src="{{asset('images/Logo/Mega-1.jpg')}}" alt="" style="width:100px;height:100px;" />
                    </div>
                </div>
            </div>
        </div>
