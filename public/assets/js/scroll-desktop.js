    ...
    _gsScope._gsDefine(
        ...
        function (t, e, i) {
            ...
            var f = function (t, i, s, r) {
                (i = i !== !1), (s = s !== !1), (r = r !== !1);
                for (
                    var n, a, o = c(r), h = i && s && r, l = o.length;
                    --l > -1;
            ...
            function (t, e, i) {
                var s = function (t) {
                    ...
                    p = (a.pauseCallback = function (t, e, i, s) {
                        ...
                        if (e || !this._forcingPlayhead) {
                            ...
                            e &&
                                e.apply(s || a.vars.callbackScope || a, i || u),
                ...
                return (
                    ...
                    (d.from = function (t, e, s, r) {
                        return this.add(
                            ((s.repeat && c.TweenMax) || i).from(t, e, s),
                            r
                        );
                    }),
        ...
        _gsScope._gsDefine(
            ...
            function (t, e) {
                ...
                var xe,
                    ...
                    Le = (B.set3DTransformRatio = B.setTransformRatio = function (
                        t
                    ) {
                        var e,
                            i,
                ...
                init: function (i, s) {
                    ...
                    for (r in s)
                        (this._start[r] = this._proxy[r] = n =
                            ...
                            '=' === a.charAt(1) &&
                                (this._end[r] =
                                    this._firstPT.s + this._firstPT.c + o),
            ...
            (U._startTime = a.time),
                ...
                (O._updateRoot = D.render = function () {
                    ...
                    if (
                        (I.length && V(),
                        U.render(
                            (a.time - U._startTime) * U._timeScale,
                            !1,
                            !1
                        ),
                        j.render(
